# jhipster-sample-bicep - Infrastructure as code
...
```
curl "https://nubesgen.com/jhipster-sample-bicep.tgz?iactool=BICEP&region=centralus&application=CONTAINER_APPS.basic&runtime=SPRING&database=POSTGRESQL.basic&gitops=true" | tar -xzvf -
```
