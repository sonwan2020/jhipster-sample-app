...
```
curl "https://nubesgen.com/jhipster-sample-demo.tgz?iactool=TERRAFORM&region=centralus&application=CONTAINER_APPS.basic&runtime=SPRING&database=POSTGRESQL.basic&gitops=true" | tar -xzvf -
```
