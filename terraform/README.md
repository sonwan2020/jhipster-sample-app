...
```
curl "https://nubesgen.com/jhipster-sample-app-service.tgz?iactool=TERRAFORM&region=eastus&application=APP_SERVICE.free&runtime=DOCKER&database=POSTGRESQL.basic&gitops=true" | tar -xzvf -
```
